...
function createIncrementInstruction(): Buffer{
  ...
  console.log("Increment____________:", JSON.stringify( data));
  return data;
}
...
function createDecrementInstruction(): Buffer{
  ...
  console.log("Decrement____________:", JSON.stringify( data), JSON.stringify(payer));
  return data;
}
...
function createSetInstruction(): Buffer{
  ...
  console.log("Set____________:", JSON.stringify( data));
  return data;
}
