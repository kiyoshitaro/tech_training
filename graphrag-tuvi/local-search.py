...
# 2. Load the Context
INPUT_DIR = "output/20240716-175017/artifacts"
...
if __name__ == "__main__":
    ...
    print(data)
    newData = {}
    newData['thienBan'] = data['thienBan']
    newData['thapNhiCung'] = []
    for cung in data['thapNhiCung']:
        tmp = cung
        tmp['cungSao'] = [i['saoTen'] for i in cung['cungSao']]
        newData['thapNhiCung'].append(cung)
    print(newData)
    history = ["đây là lá số của tôi: {}. Giúp con luận giải lá số tử vi này".format(json.dumps(newData))]
