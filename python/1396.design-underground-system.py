...
class UndergroundSystem:
    ...
    def checkOut(self, id: int, stationName: str, t: int) -> None:
      ...
      del self.checkin_map[id]
      key = start_station + ',' + stationName
      if key not in self.travel_times:
        self.travel_times[key] = (1, t - start_time)
      else:
        self.travel_times[key] = (self.travel_times[key][0] + 1, self.travel_times[key][1] + t - start_time)

    def getAverageTime(self, startStation: str, endStation: str) -> float:
      key = startStation + ',' + endStation
      return self.travel_times[key][1] / self.travel_times[key][0]
